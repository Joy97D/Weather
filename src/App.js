...
function App() {
  ...
  const [result,setresult]=useState()
   const  handleclick=async()=>{
      const user= await fetch(`http://api.openweathermap.org/geo/1.0/direct?q=${city}&limit=5&appid=451a5017cc4ccbbfd9191226a6e00359`)
   ...
   const  getweather =async()=>{
    const weather= await fetch(`https://api.openweathermap.org/data/2.5/weather?lat=${lat}&lon=${lon}&appid=451a5017cc4ccbbfd9191226a6e00359`)
